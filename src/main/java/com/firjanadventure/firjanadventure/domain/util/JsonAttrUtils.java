 ...
 * public static Map<String, Object> readJsonAttrsOrEmpty(String json,
 * ObjectMapper mapper) {
 ...
 * } catch (Exception e) {
 * throw new
 * RuntimeException("Erro ao desserializar atributos existentes do Personagem",
 * e);
 * }
 * }
 * 
 ...
 * }
 * 
 * public static Map<String, Object> shallowMerge(Map<String, Object> base,
 * Map<String, Object> incoming) {
 * Map<String, Object> merged = new
 * LinkedHashMap<>(Optional.ofNullable(base).orElseGet(LinkedHashMap::new));
 * if (incoming != null) {
